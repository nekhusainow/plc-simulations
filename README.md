...
Проект управления электродвигателем в среде CODESYS на языке Ladder Diagram (LD).
Реализованы базовые режимы пуска и остановки, логика управления и индикация состояния.
...
![demo](freertos-adc-uart-control/demo/uart_adc_demo.gif)
Демо-проект промышленной SCADA-системы с эмуляцией PLC и технологического объекта.
...
![demo](scada-industrial-demo-tracemode/screenshots/scada_demo.gif)
